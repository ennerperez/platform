...
namespace Platform.Support.Drawing.Bitmaps
{
    ...
    {
        public unsafe static void FlipYBitmap(Bitmap bitmap)
        {
            if (bitmap.PixelFormat != PixelFormat.Format1bppIndexed)
                return;

            BitmapData bitmapData = bitmap.LockBits(new System.Drawing.Rectangle(0, 0, bitmap.Width, bitmap.Height), ImageLockMode.ReadWrite, PixelFormat.Format1bppIndexed);
            ...
            fixed (byte* ptr2 = array)
            {
                ...
                {
                    Kernel32.CopyMemory((void*)ptr2, (void*)(ptr + i * bitmapData.Stride), bitmapData.Stride);
                    Kernel32.CopyMemory((void*)(ptr + i * bitmapData.Stride), (void*)(ptr + (bitmap.Height - 1 - i) * bitmapData.Stride), bitmapData.Stride);
                    Kernel32.CopyMemory((void*)(ptr + (bitmap.Height - 1 - i) * bitmapData.Stride), (void*)ptr2, bitmapData.Stride);
                }
            }
        ...
        public static IEnumerable<Color> GetPalette(Image image)
        {
            ...
            {
                var bd = b.LockBits(new System.Drawing.Rectangle(0, 0, b.Width, b.Height), ImageLockMode.ReadOnly, PixelFormat.Format24bppRgb);
