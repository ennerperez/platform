...
namespace Platform.Support
{
    ...
    namespace Core
    {
        ...
        namespace Security.Cryptography.Encryption
        {
            /// <summary>
            ...
            public class Data
            {
...
#else
                                return this.Encoding.GetString(_b, 0, _b.Length);
#endif
                            }
                        }
                    }
                ...
                {
                    get { return _b.ToBase64(); }
                    set { _b = value.FromBase64(); }
                }
