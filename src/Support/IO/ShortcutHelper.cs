...
namespace Platform.Support.IO
{
    ...
    {
        public static string CreateShortcut(ProcessStartInfo process, string targetPath, string name, string description = "")
        {
            return CreateShortcut(process.FileName, targetPath, name, description, process.Arguments, process.WorkingDirectory);
        }

        public static string CreateShortcut(string fileName, string targetPath, string name = "", string description = "", string args = "", string workDir = "")
        {
        ...
        public static string CreateDesktopShortcut(string fileName, string name = "", string description = "", string args = "", string workDir = "")
        {
        ...
        public static string CreateProgramsShortcut(string fileName, string folder = "", string name = "", string description = "", string args = "", string workDir = "")
        {
