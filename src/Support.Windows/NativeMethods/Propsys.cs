...
#endif
    {
        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern int InitPropVariantFromPropVariantVectorElem([In] ref PropVariant propvarIn, uint iElem, [Out] out PropVariant ppropvar);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern uint InitPropVariantFromFileTime([In] ref System.Runtime.InteropServices.ComTypes.FILETIME pftIn, out PropVariant ppropvar);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.I4)]
        public static extern int PropVariantGetElementCount([In] ref PropVariant propVar);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetBooleanElem([In] ref PropVariant propVar, [In]uint iElem, [Out, MarshalAs(UnmanagedType.Bool)] out bool pfVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetInt16Elem([In] ref PropVariant propVar, [In] uint iElem, [Out] out short pnVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetUInt16Elem([In] ref PropVariant propVar, [In] uint iElem, [Out] out ushort pnVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetInt32Elem([In] ref PropVariant propVar, [In] uint iElem, [Out] out int pnVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetUInt32Elem([In] ref PropVariant propVar, [In] uint iElem, [Out] out uint pnVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetInt64Elem([In] ref PropVariant propVar, [In] uint iElem, [Out] out Int64 pnVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetUInt64Elem([In] ref PropVariant propVar, [In] uint iElem, [Out] out UInt64 pnVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetDoubleElem([In] ref PropVariant propVar, [In] uint iElem, [Out] out double pnVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetFileTimeElem([In] ref PropVariant propVar, [In] uint iElem, [Out, MarshalAs(UnmanagedType.Struct)] out System.Runtime.InteropServices.ComTypes.FILETIME pftVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void PropVariantGetStringElem([In] ref PropVariant propVar, [In]  uint iElem, [Out, MarshalAs(UnmanagedType.LPWStr)] out string ppszVal);

        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void InitPropVariantFromBooleanVector([In, Out] bool[] prgf, uint cElems, out PropVariant ppropvar);
        ...
        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void InitPropVariantFromInt32Vector([In, Out] Int32[] prgn, uint cElems, out PropVariant ppropvar);
        ...
        [DllImport(ExternDll.Propsys, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern void InitPropVariantFromDoubleVector([In, Out] double[] prgn, uint cElems, out PropVariant ppropvar);
