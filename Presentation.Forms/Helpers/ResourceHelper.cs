...
namespace Platform.Presentation.Forms
{
    ...
    public sealed class ResourceHelper
    {
        ...
        /// <summary>
        /// Loads a Bitmap embedded in ResourceManager.
        /// </summary>
        /// <param name="resource">The name of the Bitmap to load.</param>
        public static Bitmap LoadBitmap(string resource, ResourceManager resmanager)
        {
            //	Get the bitmap.
            Bitmap bitmap;
            lock (typeof(ResourceHelper))
            {
                ...
                {
                    bitmap = resmanager.GetObject(resource) as Bitmap;
